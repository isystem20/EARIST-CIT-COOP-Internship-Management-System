...
class RequestModel extends CI_Model {
	...
	function LoadStudentRequests($userid){
		$this->db->select('r.Id, r.DocumentId, r.ApplicationId, r.RecordId, r.CreatedAt, r.Status, s.FirstName, s.LastName, s.Code as StudentCode, concat(s.Address1," ",si.Name) as StudentAddress, s.GuardianContact, s.GuardianName, s.MobileNo, a.ContactPerson, a.CPTitle as ContactPersonTitle, a.ContactPersonFirstName, a.ContactPersonLastName, a.ContactPersonGender, or.SFirstName as SFirstName, or.SLastName as SLastName, d.Code as DocCode, d.DocumentName as DocumentName, d.Content, a.LabelDate as DocumentDate, a.ContactPerson, a.Designation as ContactPerson_Designation, a.Address1 as CompanyAddress1, concat(ci.Name," ",a.Zip) as CompanyAddress2, c.CompanyName as CompanyName, s.FirstName as StudentFName, s.LastName as StudentLName, concat(s.FirstName," ",s.LastName) as StudentFullName, or.Hours as StudentOJTHours,s.Gender as StudentGender, "" as StudentPronoun, "" as Student3rdPerson, concat(or.SFirstName," ",or.SLastName) as TrainingSupervisor, or.SupervisorPosition as TrainingSupervisor_Designation, concat(or.MFirstName," ",or.MLastName) as TrainingManager, or.StartDate as StudentStartDate, or.EndDate as StudentEndDate, or.ScheduleDays as StudentScheduleDays, or.ScheduleTime as StudentScheduleTime');
		...
		$this->db->join('tbl_cities si','si.Id = s.CityId','left outer');	
